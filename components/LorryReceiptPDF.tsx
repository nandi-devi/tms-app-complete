            ...
            <div className="border-2 border-black p-2">
                ...
                <div className="grid grid-cols-3 gap-1 mb-1">
                    ...
                    <div className="border border-black p-1 text-center flex flex-col justify-center">
                        <p className="font-bold text-lg">AT {lorryReceipt.riskBearer?.toUpperCase() || 'CARRIER'}'S RISK</p>
                        <p className="text-xs text-gray-600 mt-1">(Risk Bearer Information)</p>
                    </div>
                    <div className="border border-black p-1">
                        ...
                        <div className="min-h-[10rem]">
                            {(lorryReceipt.packages || []).map((pkg, i) => (
                                <div key={i} className="grid grid-cols-8 border-b border-black hover:bg-gray-50 h-[2.5rem]">
                                    ...
                                    <div className="col-span-1 border-r border-black p-2 text-xs text-center flex items-center justify-center">{pkg.actualWeight || 0}</div>
                                    <div className="col-span-1 p-2 text-xs text-center flex items-center justify-center">{pkg.chargedWeight || 0}</div>
                                </div>
                            ))}
